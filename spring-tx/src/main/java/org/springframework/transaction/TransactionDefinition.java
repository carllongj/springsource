...
public interface TransactionDefinition {
	...
	/**
	 * 不支持当前事务,总是以非事务执行,若当前存在事务,则挂起事务
	 *
	...
	/**
	 * 若当前事务存在,则进行嵌套事务,如果没有事务,则执行与 PROPAGATION_NOT_REQUIRE 同效果
	 *
